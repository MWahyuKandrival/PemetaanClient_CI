                ...
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url('Client/update'); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="henti_kerja_sama">Tanggal Henti Kerja Sama</label>
                                <input name="henti_kerja_sama" autocomplete="off" value="<?= $client['henti_kerja_sama']; ?>" type="date" class="form-control" id="mulai_kerja_sama">
                                <?= form_error('henti_kerja_sama', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="status_kerja_sama">Status Kerja Sama</label>
                                <select name="status_kerja_sama" value="<?= $client['status_kerja_sama']; ?>" class="form-control" id="status_kerja_sama">
                                    <option value="Aktif">Aktif</option>
                                    <option value="Berakhir">Berakhir</option>
                                </select>
                                <?= form_error('status_kerja_sama', '<small class="text-danger pl-3">', '</small>'); ?>
                            ...
                            <button type="submit" name="tambah" class="btn btn-primary float-left">Edit Bank</button>
                            <a href="<?= base_url('Client') ?>" style="margin-left:10px;" class="btn btn-success float-left">Tutup</a>
                        </form>
                    </div>
                </div>
