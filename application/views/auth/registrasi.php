...
<head>
  ...
  <title>Pemetaan Client &mdash; Register</title>
  <img src="assets/img/icon.png" class="w3-circle" alt="Alps">
  <!-- General CSS Files -->
          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <form method="POST" action="<?= base_url('auth/addregistrasi'); ?>" class="needs-validation" novalidate="">
